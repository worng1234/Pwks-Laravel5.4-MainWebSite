    ...
    public function addstudentcore(Request $request)
    {
        ...
        if ($data == NULL) {
            ...
            $addressstudent = new addressstudentModel([
                ...
                "sub_district_n" => $request->get('sub_district_n'),
            ...
            $parentstudent = new parentstudentModel([
                ...
                "sub_district_f" => $request->get('sub_district_f'),
                ...
                "sub_district_m" => $request->get('sub_district_m'),
                ...
                "sub_district_p" => $request->get('sub_district_p'),
