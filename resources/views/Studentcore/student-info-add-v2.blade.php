							...
							<div class="wizard-header">
											...
											<div class="row">
												...
												<div class="col-6 col-md-3">
													<div class="form-group form-group-default">
														...
														<select class="form-control" id="formGroupDefaultSelect" required>
															<option>เลือก</option>
															<option>1</option>
															<option>1</option>
															<option>1</option>
											...
											<div class="row">
												...
												<div class="col-sm-6 col-md-2">
													<div class="form-group form-group-default">
														...
														<input id="Name" type="text" class="form-control" placeholder="(ถ้ามี)" required>
													</div> 
												</div>
												<div class="col-sm-6 col-md-4">
													<div class="form-group form-group-default">
								...
								<div class="wizard-action">
									...
									<div class="pull-right">
										...
										<input type="button" class="btn btn-finish btn-info" name="finish" value="ยืนยัน" style="display: none;">
									</div>
									<div class="clearfix"></div>
								</div>
							</form>
