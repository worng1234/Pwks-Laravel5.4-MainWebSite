							...
							<div class="card">
								...
								<div class="card-body">
									<ol>
										...
										<li>เอกสารที่ใช้ประกอบข้อมูลพื้นฐานนักเรียนให้ใช้เป็นไฟล์ .pdf หากไม่สะดวกให้ใช้เป็นไฟลร์รูปภาพ .jpg หรือ .png </li>
										<li>เอกสารที่ใช้ประกอบข้อมูลพื้นฐานมีดังนี้
											</br>&nbsp;- ไฟล์รูปหน้าตรงขนาด 2 นิ้ว
											</br>&nbsp;- ไฟล์สำเนาบัตรประจำตัวประชาชนของนักเรียน
											</br>&nbsp;- ไฟล์สำเนาทะเบียนบ้านของนักเรียน
											</br>&nbsp;- ไฟล์ใบ ปพ.1 (ด้านหน้าและด้านหลัง)ของนักเรียน
											</br>&nbsp;- ไฟล์สำเนาบัตรประจำตัวประชาชนของบิดา มารดา
											</br>&nbsp;- ไฟล์สำเนาทะเบียนบ้านของบิดา มารดา
											</br>&nbsp;- ไฟล์สำเนาบัตรประจำตัวประชาชนของผู้ปกครอง(ในกรณีไม่ได้อยู่กับบิดา มารดา)
											</br>&nbsp;- ไฟล์สำเนาทะเบียนบ้านของผู้ปกครอง(ในกรณีไม่ได้อยู่กับบิดา มารดา)
											</br>&nbsp;- ไฟล์ใบสูติบัตรของนักเรียน
											</br>&nbsp;- ไฟล์ใบรับรองความพิการ(ในกรณีที่เป็นผู้พิการด้านต่างๆ *เอกสารต้องถูกรับรองโดยแพทย์เท่านั้น)
										</li>
										<li style="color:red;">เตรียมเอกสารที่เกี่ยวข้องให้พร้อมก่อนทำการกรอกข้อมูล</li>
								...
								<div class="card-footer" align="center">
									...
									<div id="dvagreement" style="display: none">
										<a type="button" class="btn btn-info" href="{{ url('/Addstudentcore')}}"><i class="fas fa-file-signature"></i> กรอกข้อมูล</a><br><br>
									</div>
								</div>
							</div>
						</div>
