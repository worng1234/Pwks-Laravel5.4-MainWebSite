                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <h1><i class="fas fa-times-circle" style="color:red;"></i> บันทึกข้อมูลผิดพลาดผิดพลาด</h1>

                                <div>
                                    <h4>ท่านได้ทำการบันทึกข้อมูลไปแล้ว 
                                    </br>"เนื่องระบบตรวจสอบพบว่าเลขบัตรประจำตัวประชาชนของนักเรียนได้บันทึกลงสู่ระบบแล้วจึงไม่สามารถบันทึกข้อมูลได้"</h4> 
                                </div>
                                </br>
