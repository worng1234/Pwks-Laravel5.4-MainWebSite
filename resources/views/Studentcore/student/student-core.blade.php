										...
										<div class="card-body">
											<div class="alert alert-info" role="alert" align="center">
												...
												<h5><i class="fas fa-info-circle" style="color:red;"></i>
													ช่องที่มีเครื่อง * จำเป็นต้องกรอกข้อมูลห้ามปล่อยว่างเด็ดขาด แต่หากไม่มีข้อมูลจริงๆให้ใส่เครื่องหมาย -</h5>
												<h5><i class="fas fa-info-circle" style="color:red;"></i>
													...
													<div class="tab-pane active" id="info">
														<div class="row">
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
																	...
																	<input id="Name" type="text" class="form-control" name="student_id" onblur="checkLengthStudent(this)" pattern="^[0-9\s]+$" title="กรุณากรอกเป็นตัวเลข" maxlength="5" required>
																</div>
															</div>
															...
															<div class="col-sm-6 col-md-1">
																<div class="form-group form-group-default">
																	<label>เลขที่</label>
																	<input id="Name" type="text" class="form-control" name="student_number" pattern="^[0-9\s]+$" title="กรุณากรอกเป็นตัวเลข" maxlength="2" required>
																</div>
															</div>
														</div>
														<div class="row">
														...
														<div class="row">
															...
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	...
																	<input id="Name" type="text" class="form-control" name="fname" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกชื่อเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-sm-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>ชื่อกลาง</label>
																	<input id="Name" type="text" class="form-control" placeholder="(ถ้ามี)" pattern="^[ก-๏\s]+$" title="กรุณากรอกชื่อกลางเป็นภาษาไทย" name="name_cen">
																</div>
															</div>
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	<label>*นามสกุลภาษาไทย</label>
																	<input id="Name" type="text" class="form-control" name="surname" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกนามสกุลเป็นภาษาไทย" required>
																</div>
															</div>
														</div>
														<div class="row">
															...
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	...
																	<input id="Name" type="text" class="form-control" name="name_eng" onblur="checktextEng(this)" pattern="^[a-zA-Z\s]+$" title="กรุณากรอกชื่อเป็นภาษาอังกฤษ" required>
																</div>
															</div>
															<div class="col-sm-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>ชื่อกลาง(ภาษาอังกฤษ)</label>
																	<input id="Name" type="text" class="form-control" placeholder="(ถ้ามี)" pattern="^[a-zA-Z\s]+$" title="กรุณากรอกชื่อกลางเป็นภาษาอังกฤษ" name="name_cen_eng">
																</div>
															</div>
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	<label>*นามสกุล(ภาษาอังกฤษ)</label>
																	<input id="Name" type="text" class="form-control" name="surname_eng" onblur="checktextEng(this)" pattern="^[a-zA-Z\s]+$" title="กรุณากรอกนามสกุลเป็นภาษาอังกฤษ" required>
																</div>
															</div>
														</div>
														...
														<div class="row">
															...
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	<label>*เดือน:</label>
																	<select class="form-control" id="slctMounth" name="birth_month" onchange="populate(this.id,'slct2')" required>
																		<option>เลือก</option>
															...
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	<label>*วัน:</label>
																	<select class="form-control" id="slct2" name="birth_day" required>
														...
														<div class="row">
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
																	...
																	<input id="Name" type="text" class="form-control" name="nickname" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกชื่อเล่นเป็นภาษาไทย">
																</div>
															</div>
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
															...
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>ศาสนา</label>
																	<input id="Name" type="text" class="form-control" name="religion" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกศาสนาเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>*เชื้อชาติ</label>
																	<input id="Name" type="text" class="form-control" name="origin" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเชื่อชาติเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>*สัญชาติ</label>
																	<input id="Name" type="text" class="form-control" name="nationality" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกสัญชาติเป็นภาษาไทย" required>
																</div>
															</div>
														</div>
														<div class="row">
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	...
																	<input id="Name" type="text" class="form-control" name="language" pattern="^[ก-๏\s]+$" title="กรุณากรอกข้อมูลเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	<label>*หมายเลขโทรศัพท์ที่สามารถติดต่อได้</label>
																	<input id="Name" type="text" class="form-control" name="tel_s" onblur="checkLengthTel(this)" pattern="^[0-9\s]+$" title="กรุณากรอกเบอร์โทรเป็นตัวเลข" maxlength="10" required>
																</div>
															</div>
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
														...
														<div class="row">
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
																	...
																	<input id="Name" type="text" class="form-control" name="house_number" pattern="^[/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง" maxlength="10" required>
																</div>
															</div>
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>*หมู่</label>
																	<input id="Name" type="text" class="form-control" name="group" pattern="^[/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง" maxlength="10" required>
																</div>
															</div>
															<div class="col-sm-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>*ชื่อหมู่บ้าน</label>
																	<input id="Name" type="text" class="form-control" name="village" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกชื่อหมู่บ้านเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>ซอย</label>
																	<input id="Name" type="text" class="form-control" pattern="^[-||/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง" maxlength="10" name="alley">
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>ถนน</label>
																	<input id="Name" type="text" class="form-control" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกถนนเป็นภาษาไทย" name="street">
																</div>
															</div>
														</div>
														<div class="row">
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	...
																	<input id="Name" type="text" class="form-control" name="sub_district" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกตำบลเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>*อำเภอ/เขต</label>
																	<input id="Name" type="text" class="form-control" name="district" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกอำเภอเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>*จังหวัด</label>
																	<input id="Name" type="text" class="form-control" name="province" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกจังหวัดเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>*รหัสไปรษณีย์</label>
																	<input id="Name" type="text" class="form-control" name="post" pattern="^[0-9\s]+$" title="กรุณากรอกรหัสไปรษณีย์เป็นตัวเลข" maxlength="6" required>
																</div>
															</div>
														</div>
														...
														<div id="dvaddress" style="display: none">
															<div class="row">
																<div class="col-6 col-md-2">
																	<div class="form-group form-group-default">
																		<label>บ้านเลขที่</label>
																		<input id="Name" type="text" class="form-control" name="house_number_n" pattern="^[/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง" maxlength="10">
																	</div>
																</div>
																<div class="col-6 col-md-2">
																	<div class="form-group form-group-default">
																		<label>หมู่</label>
																		<input id="Name" type="text" class="form-control" name="group_n" pattern="^[/||0-9\s]+$" title="กรุณากรอกข้อมูลให้ถูกต้อง">
																	</div>
																</div>
																<div class="col-sm-6 col-md-3">
																	<div class="form-group form-group-default">
																		<label>ชื่อหมู่บ้าน</label>
																		<input id="Name" type="text" class="form-control" name="village_n" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกชื่อหมู่บ้านเป็นภาษาไทย">
																	</div>
																</div>
																<div class="col-6 col-md-2">
																	<div class="form-group form-group-default">
																		<label>ซอย</label>
																		<input id="Name" type="text" class="form-control" name="alley_n" pattern="^[-||/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง" maxlength="10">
																	</div>
																</div>
																<div class="col-6 col-md-3">
																	<div class="form-group form-group-default">
																		<label>ถนน</label>
																		<input id="Name" type="text" class="form-control" name="street_n" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกถนนเป็นภาษาไทย">
																	</div>
																</div>
															</div>
															<div class="row">
																<div class="col-6 col-md-3">
																	<div class="form-group form-group-default">
																		<label>ตำบล/แขวง</label>
																		<input id="Name" type="text" class="form-control" name="sub_district_n" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกตำบลเป็นภาษาไทย">
																	</div>
																</div>
																<div class="col-6 col-md-3">
																	<div class="form-group form-group-default">
																		<label>อำเภอ/เขต</label>
																		<input id="Name" type="text" class="form-control" name="district_n" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกอำเภอเป็นภาษาไทย">
																	</div>
																</div>
																<div class="col-6 col-md-3">
																	<div class="form-group form-group-default">
																		<label>จังหวัด</label>
																		<input id="Name" type="text" class="form-control" name="province_n" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกจังหวัดเป็นภาษาไทย">
																	</div>
																</div>
																<div class="col-6 col-md-3">
																	<div class="form-group form-group-default">
																		<label>รหัสไปรษณีย์</label>
																		<input id="Name" type="text" class="form-control" name="post_n" pattern="^[0-9\s]+$" title="กรุณากรอกรหัสไปรษณีย์เป็นตัวเลข" maxlength="6">
																	</div>
																</div>
															</div>
														</div>
													...
													<div class="tab-pane" id="ability">
														...
														<div class="row">
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	...
																	<input id="Name" type="text" class="form-control" name="final_school" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกชื่อโรงเรียนเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-6 col-md-4">
																<div class="form-group form-group-default">
															...
															<div class="col-6 col-md-4">
																<div class="form-group form-group-default">
																	...
																	<input id="Name" type="text" class="form-control" name="avg_grade" pattern="^[.||0-9\s]+$" title="กรุณากรอกชื่อโรงเรียนเป็นตัวเลข" required>
																</div>
															</div>
														</div>
														<div class="row">
															<div class="col-6 col-md-4">
																<div class="form-group form-group-default">
																	<label>*ตำบล/แขวง</label>
																	<input id="Name" type="text" class="form-control" name="f_sub_district" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกตำบลเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-6 col-md-4">
																<div class="form-group form-group-default">
																	<label>*อำเภอ/เขต</label>
																	<input id="Name" type="text" class="form-control" name="f_district" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกอำเภอเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	<label>*จังหวัด</label>
																	<input id="Name" type="text" class="form-control" name="f_province" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกจังหวัดเป็นภาษาไทย" required>
																</div>
															</div>
														</div>
														...
														<div class="row">
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>*1)</label>
																	<input id="Name" type="text" class="form-control" name="like_subject1" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกวิชาที่ชอบเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>*2)</label>
																	<input id="Name" type="text" class="form-control" name="like_subject2" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกวิชาที่ชอบเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>*3)</label>
																	<input id="Name" type="text" class="form-control" name="like_subject3" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกวิชาที่ชอบเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>*4)</label>
																	<input id="Name" type="text" class="form-control" name="like_subject4" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกวิชาที่ชอบเป็นภาษาไทย" required>
																</div>
															</div>
														</div>
														<div class="row">
														...
														<div class="row">
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>*1)</label>
																	<input id="Name" type="text" class="form-control" name="unlike_subject1" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกวิชาที่ไม่ชอบเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>*2)</label>
																	<input id="Name" type="text" class="form-control" name="unlike_subject2" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกวิชาที่ไม่ชอบเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>*3)</label>
																	<input id="Name" type="text" class="form-control" name="unlike_subject3" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกวิชาที่ไม่ชอบเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>*4)</label>
																	<input id="Name" type="text" class="form-control" name="unlike_subject4" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกวิชาที่ไม่ชอบเป็นภาษาไทย" required>
																</div>
															</div>
														</div>
														<div class="row">
														...
														<div class="row">
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	...
																	<input id="Name" type="text" class="form-control" name="dream_job" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย">
																</div>
															</div>
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	<label>เพราะอะไร</label>
																	<input id="Name" type="text" class="form-control" name="because" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย">
																</div>
															</div>
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	<label>ความสามารถพิเศษ</label>
																	<input id="Name" type="text" class="form-control" name="talent" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย">
																</div>
															</div>
														</div>
														<div class="row">
														...
														<div class="row">
															...
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	...
																	<input id="Name" type="text" class="form-control" name="distance" pattern="^[0-9\s]+$" title="กรุณากรอกวิชาที่ไม่ชอบเป็นตัวเลข(เมตร)">
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>ระยะห่างจาก ร.ร. (ลาดยาง) เมตร</label>
																	<input id="Name" type="text" class="form-control" name="long_distance" pattern="^[0-9\s]+$" title="กรุณากรอกวิชาที่ไม่ชอบเป็นตัวเลข(เมตร)">
																</div>
															</div>
														</div>
														<div style="border-radius: 5px; background-color: #8B469B; margin-bottom: 15px; color: white;">
														...
														<div class="row">
															<div class="col-6 col-md-6">
																<div class="form-group form-group-default">
																	...
																	<input id="Name" type="text" class="form-control" name="good_guy" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-6 col-md-6">
																<div class="form-group form-group-default">
																	<label>*นักเรียนคิดว่าสังคมที่ดีควรมีลักษณะอย่างไร</label>
																	<input id="Name" type="text" class="form-control" name="social_good" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย" required>
																</div>
															</div>
														</div>
														<div class="row">
													...
													<div class="tab-pane" id="health">
														...
														<div class="row">
															<div class="col-6 col-md-6">
																<div class="form-group form-group-default">
																	<label>*น้ำหนัก</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="weight" pattern="^[0-9\s]+$" title="กรุณากรอกเป็นตัวเลข" maxlength="3" required>
																</div>
															</div>
															<div class="col-6 col-md-6">
																<div class="form-group form-group-default">
																	<label>*ส่วนสูง</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="height" pattern="^[0-9\s]+$" title="กรุณากรอกเป็นตัวเลข" maxlength="3" required>
																</div>
															</div>
														</div>
														<div class="row">
															...
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	...
																	<input id="Name" type="text" class="form-control" placeholder="" name="remedy" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย" maxlength="3">
																</div>
															</div>
														</div>
														<div class="row">
													...
													<div class="tab-pane" id="family">
														...
														<div class="row">
															<div class="col-sm-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>คำนำหน้าชื่อ</label>
																	<input name="prename_f" type="text" class="form-control" pattern="^[.||ก-๏\s]+$" title="กรุณากรอกคำนำหน้าชื่อเป็นภาษาไทย" placeholder="">
																</div>
															</div>
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	<label>ชื่อภาษาไทย</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="name_f" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกชื่อเป็นภาษาไทย">
																</div>
															</div>
															<div class="col-sm-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>ชื่อกลาง</label>
																	<input id="Name" type="text" class="form-control" placeholder="(ถ้ามี)" name="name_cen_f" pattern="^[ก-๏\s]+$" title="กรุณากรอกชื่อกลางเป็นภาษาไทย">
																</div>
															</div>
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	<label>นามสกุลภาษาไทย</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="surname_f" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกนามสกุลเป็นภาษาไทย">
																</div>
															</div>
														</div>
														<div class="row">
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	<label>เลขประจำตัวประชาชน</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="id_father" pattern="^[gG||0-9\s]+$" title="กรุณากรอกเลขบัตรประจำตัวประชาชนให้ถูกต้อง" maxlength="13">
																</div>
															</div>
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
															...
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>อายุ</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="age_f" pattern="^[0-9\s]+$" title="กรุณากรอกเป็นตัวเลข" maxlength="3">
																</div>
															</div>
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
														...
														<div class="row">
															...
															<div class="col-sm-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>หมายเลขโทรศัพท์ที่สามารถติดต่อได้</label>
																	<input id="Name" type="text" class="form-control" name="tel_f" pattern="^[0-9\s]+$" title="กรุณากรอกหมายเลขโทรศัพท์เป็นตัวเลข 10 หลัก" maxlength="10">
																</div>
															</div>
														</div>
														<div class="row">
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>บ้านเลขที่</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="house_number_f" pattern="^[/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง" maxlength="10">
																</div>
															</div>
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>หมู่</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="group_f" pattern="^[/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง" maxlength="10">
																</div>
															</div>
															<div class="col-sm-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>ชื่อหมู่บ้าน</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="village_f" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย">
																</div>
															</div>
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>ซอย</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="alley_f" pattern="^[-||/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง" maxlength="10">
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>ถนน</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="street_f" pattern="^[ก-๏||-||/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง">
																</div>
															</div>
														</div>
														<div class="row">
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>ตำบล/แขวง</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="sub_district_f" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย">
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>อำเภอ/เขต</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="district_f" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย">
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>จังหวัด</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="province_f" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย">
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>รหัสไปรษณีย์</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="post_f" pattern="^[0-9\s]+$" title="กรุณากรอกเป็นตัวเลข" maxlength="6">
																</div>
															</div>
														</div>
														...
														<div class="row">
															<div class="col-sm-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>คำนำหน้าชื่อ</label>
																	<input name="prename_m" type="text" class="form-control" pattern="^[.||ก-๏\s]+$" title="กรุณากรอกคำนำหน้าชื่อเป็นภาษาไทย" placeholder="">
																</div>
															</div>
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	<label>ชื่อภาษาไทย</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="name_m" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกชื่อเป็นภาษาไทย">
																</div>
															</div>
															<div class="col-sm-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>ชื่อกลาง</label>
																	<input id="Name" type="text" class="form-control" placeholder="(ถ้ามี)" name="name_cen_m" pattern="^[ก-๏\s]+$" title="กรุณากรอกชื่อกลางเป็นภาษาไทย">
																</div>
															</div>
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	<label>นามสกุลภาษาไทย</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="surname_m" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกนามสกุลเป็นภาษาไทย">
																</div>
															</div>
														</div>
														<div class="row">
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	<label>เลขประจำตัวประชาชน</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="id_mother" pattern="^[gG||0-9\s]+$" title="กรุณากรอกเลขบัตรประจำตัวประชาชนให้ถูกต้อง" maxlength="13">
																</div>
															</div>
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
															...
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>อายุ</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="age_m" pattern="^[0-9\s]+$" title="กรุณากรอกเป็นตัวเลข" maxlength="3">
																</div>
															</div>
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
														...
														<div class="row">
															...
															<div class="col-sm-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>หมายเลขโทรศัพท์ที่สามารถติดต่อได้</label>
																	<input id="Name" type="text" class="form-control" name="tel_m" pattern="^[0-9\s]+$" title="กรุณากรอกหมายเลขโทรศัพท์เป็นตัวเลข 10 หลัก" maxlength="10">
																</div>
															</div>
														</div>
														<div class="row">
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>บ้านเลขที่</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="house_number_m" pattern="^[/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง" maxlength="10">
																</div>
															</div>
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>หมู่</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="group_m" pattern="^[/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง" maxlength="10">
																</div>
															</div>
															<div class="col-sm-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>ชื่อหมู่บ้าน</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="village_m" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย">
																</div>
															</div>
															<div class="col-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>ซอย</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="alley_m" pattern="^[-||/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง" maxlength="10">
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>ถนน</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="street_m" pattern="^[ก-๏||-||/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง">
																</div>
															</div>
														</div>
														<div class="row">
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>ตำบล/แขวง</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="sub_district_m" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย">
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>อำเภอ/เขต</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="district_m" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย">
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>จังหวัด</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="province_m" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย">
																</div>
															</div>
															<div class="col-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>รหัสไปรษณีย์</label>
																	<input id="Name" type="text" class="form-control" placeholder="" name="post_m" pattern="^[0-9\s]+$" title="กรุณากรอกเป็นตัวเลข" maxlength="6">
																</div>
															</div>
														</div>
														...
														<div id="dvparent" style="display: none">
															<div class="row">
																<div class="col-sm-6 col-md-2">
																	<div class="form-group form-group-default">
																		<label>คำนำหน้าชื่อ</label>
																		<input name="prename_p" type="text" class="form-control" pattern="^[.||ก-๏\s]+$" title="กรุณากรอกคำนำหน้าชื่อเป็นภาษาไทย" placeholder="">
																	</div>
																</div>
																<div class="col-sm-6 col-md-4">
																	<div class="form-group form-group-default">
																		<label>ชื่อภาษาไทย</label>
																		<input id="Name" type="text" class="form-control" placeholder="" name="name_p" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกชื่อเป็นภาษาไทย">
																	</div>
																</div>
																<div class="col-sm-6 col-md-2">
																	<div class="form-group form-group-default">
																		<label>ชื่อกลาง</label>
																		<input id="Name" type="text" class="form-control" placeholder="(ถ้ามี)" name="name_cen_p" pattern="^[ก-๏\s]+$" title="กรุณากรอกชื่อกลางเป็นภาษาไทย">
																	</div>
																</div>
																<div class="col-sm-6 col-md-4">
																	<div class="form-group form-group-default">
																		<label>นามสกุลภาษาไทย</label>
																		<input id="Name" type="text" class="form-control" placeholder="" name="surname_p" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกนามสกุลเป็นภาษาไทย">
																	</div>
																</div>
															</div>
															<div class="row">
																<div class="col-sm-6 col-md-4">
																	<div class="form-group form-group-default">
																		<label>เลขประจำตัวประชาชน</label>
																		<input id="Name" type="text" class="form-control" placeholder="" name="id_parent" <input id="Name" type="text" class="form-control" placeholder="" name="id_mother" pattern="^[gG||0-9\s]+$" title="กรุณากรอกเลขบัตรประจำตัวประชาชนให้ถูกต้อง" maxlength="13">>
																	</div>
																</div>
																<div class="col-6 col-md-4">
																	<div class="form-group form-group-default">
																...
																<div class="col-6 col-md-2">
																	<div class="form-group form-group-default">
																		<label>อายุ</label>
																		<input id="Name" type="text" class="form-control" placeholder="" name="age_p" pattern="^[0-9\s]+$" title="กรุณากรอกเป็นตัวเลข" maxlength="3">
																	</div>
																</div>
																<div class="col-sm-6 col-md-3">
																	<div class="form-group form-group-default">
																		<label>ความสัมพันธ์ผู้ปกครอง</label>
																		<input id="Name" type="text" class="form-control" placeholder="" name="relationship_parent" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย">
																	</div>
																</div>
															</div>
															<div class="row">
																...
																<div class="col-sm-6 col-md-3">
																	<div class="form-group form-group-default">
																		<label>หมายเลขโทรศัพท์ที่สามารถติดต่อได้</label>
																		<input id="Name" type="text" class="form-control" name="tel_p" pattern="^[0-9\s]+$" title="กรุณากรอกหมายเลขโทรศัพท์เป็นตัวเลข 10 หลัก" maxlength="10">
																	</div>
																</div>
															</div>
															<div class="row">
																<div class="col-6 col-md-2">
																	<div class="form-group form-group-default">
																		<label>บ้านเลขที่</label>
																		<input id="Name" type="text" class="form-control" placeholder="" name="house_number_p" pattern="^[/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง" maxlength="10">
																	</div>
																</div>
																<div class="col-6 col-md-2">
																	<div class="form-group form-group-default">
																		<label>หมู่</label>
																		<input id="Name" type="text" class="form-control" placeholder="" name="group_p" pattern="^[/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง" maxlength="10">
																	</div>
																</div>
																<div class="col-sm-6 col-md-3">
																	<div class="form-group form-group-default">
																		<label>ชื่อหมู่บ้าน</label>
																		<input id="Name" type="text" class="form-control" placeholder="" name="village_p" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย">
																	</div>
																</div>
																<div class="col-6 col-md-2">
																	<div class="form-group form-group-default">
																		<label>ซอย</label>
																		<input id="Name" type="text" class="form-control" placeholder="" name="alley_p" pattern="^[-||/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง" maxlength="10">
																	</div>
																</div>
																<div class="col-6 col-md-3">
																	<div class="form-group form-group-default">
																		<label>ถนน</label>
																		<input id="Name" type="text" class="form-control" placeholder="" name="street_p" pattern="^[ก-๏||-||/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง">
																	</div>
																</div>
															</div>
															<div class="row">
																<div class="col-6 col-md-3">
																	<div class="form-group form-group-default">
																		<label>ตำบล/แขวง</label>
																		<input id="Name" type="text" class="form-control" placeholder="" name="sub_district_p" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย">
																	</div>
																</div>
																<div class="col-6 col-md-3">
																	<div class="form-group form-group-default">
																		<label>อำเภอ/เขต</label>
																		<input id="Name" type="text" class="form-control" placeholder="" name="district_p" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย">
																	</div>
																</div>
																<div class="col-6 col-md-3">
																	<div class="form-group form-group-default">
																		<label>จังหวัด</label>
																		<input id="Name" type="text" class="form-control" placeholder="" name="province_p" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกเป็นภาษาไทย">
																	</div>
																</div>
																<div class="col-6 col-md-3">
																	<div class="form-group form-group-default">
																		<label>รหัสไปรษณีย์</label>
																		<input id="Name" type="text" class="form-control" placeholder="" name="post_p" pattern="^[0-9\s]+$" title="กรุณากรอกเป็นตัวเลข" maxlength="6">
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="row">
															<div class="col-6 col-md-8">
																<div class="form-group form-group-default">
																	...
																	<select class="form-control" id="formGroupDefaultSelect" name="status_parent" required>
																		<option>เลือก</option>
														...
														<div class="row">
															<div class="col-sm-6 col-md-9">
																<div class="form-group form-group-default">
																	...
																	<input id="Name" type="text" class="form-control" name="student_job" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกชื่อเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-sm-6 col-md-3">
																<div class="form-group form-group-default">
																	<label>*นักเรียนนำเงินมาโรงเรียนวันละ (บาท)</label>
																	<select class="form-control" id="formGroupDefaultSelect" name="student_money" required>
																		<option>เลือก</option>
														...
														<div class="row">
															<div class="col-sm-6 col-md-4">
																<div class="form-group form-group-default">
																	...
																	<select class="form-control" id="formGroupDefaultSelect" name="parent_money" required>
																		<option>เลือก</option>
																		<option value="0 - 9000">0 - 9000</option>
																		<option value="9,001 - 15,000">9,001 - 15,000</option>
																		<option value="15,001 - 30,000">15,001 - 30,000</option>
															...
															<div class="col-sm-6 col-md-6">
																<div class="form-group form-group-default">
																	...
																	<input id="Name" type="text" class="form-control" name="parent_total"  pattern="^[ก-๏\s]+$" title="กรุณากรอกชื่อเป็นภาษาไทย" required>
																</div>
															</div>
															<div class="col-sm-6 col-md-2">
																<div class="form-group form-group-default">
																	<label>*เกี่ยวข้องเป็น</label>
																	<input id="Name" type="text" class="form-control" name="parent_house" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกชื่อเป็นภาษาไทย" required>
																</div>
															</div>
														</div>
														<div class="row">
																...
																<div class="form-check">
																	...
																	<div id="dvtotal" style="display: none">
																		<div class="form-group form-group-default">
																			...
																			<input id="Name" type="text" class="form-control" name="job_detail" onblur="checktext(this)" pattern="^[ก-๏\s]+$" title="กรุณากรอกชื่อเป็นภาษาไทย">
																		</div>
																		<div class="form-group form-group-default">
...
<script>
	...
	<script>
		function checktextEng(el) {
			var test = el.value;
			if (!test.match(/^([a-zA-Z\s])+$/i)) {
				alert("กรอกได้เฉพาะภาษาไทยเท่านั้น");
			}
		}
	</script>
	...
	<script>
		function populate(s1, s2) {
			...
			if (s1.value == "01") {
				var optionArray = ["|เลือก", "01|1", "02|2", "03|3", "04|4", "05|5", "06|6", "07|7", "08|8", "09|9", "10|10", "11|11", "12|12", "13|13", "14|14", "15|15", "16|16", "17|17", "18|18", "19|19", "20|20", "21|21", "22|22", "23|23", "24|24", "25|25", "26|26", "27|27", "28|28", "29|29", "30|30", "31|31"];

			} else if (s1.value == "02") {
				var optionArray = ["|เลือก", "01|1", "02|2", "03|3", "04|4", "05|5", "06|6", "07|7", "08|8", "09|9", "10|10", "11|11", "12|12", "13|13", "14|14", "15|15", "16|16", "17|17", "18|18", "19|19", "20|20", "21|21", "22|22", "23|23", "24|24", "25|25", "26|26", "27|27", "28|28", "29|29"];

			} else if (s1.value == "03") {
				var optionArray = ["|เลือก", "01|1", "02|2", "03|3", "04|4", "05|5", "06|6", "07|7", "08|8", "09|9", "10|10", "11|11", "12|12", "13|13", "14|14", "15|15", "16|16", "17|17", "18|18", "19|19", "20|20", "21|21", "22|22", "23|23", "24|24", "25|25", "26|26", "27|27", "28|28", "29|29", "30|30", "31|31"];

			} else if (s1.value == "04") {
				var optionArray = ["|เลือก", "01|1", "02|2", "03|3", "04|4", "05|5", "06|6", "07|7", "08|8", "09|9", "10|10", "11|11", "12|12", "13|13", "14|14", "15|15", "16|16", "17|17", "18|18", "19|19", "20|20", "21|21", "22|22", "23|23", "24|24", "25|25", "26|26", "27|27", "28|28", "29|29", "30|30"];
