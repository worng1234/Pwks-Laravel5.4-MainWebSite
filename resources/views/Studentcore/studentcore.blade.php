															...
															<tr>
																...
																<td align="center">
																	<form role="form" method="post" action="?r=admin_student_edit">
																		...
																		<a href='{{ url("/deletestudentcore/{$value->id}")}}' class="btn btn-danger btn-xs" title="" onclick="return confirm('ต้องการที่จะลบข้อมูลใน column นี้ใช่ไหม')"> <i class="fas fa-trash"></i> </a>
																	</form>
																</td>
															</tr>
                                                            @endforeach
