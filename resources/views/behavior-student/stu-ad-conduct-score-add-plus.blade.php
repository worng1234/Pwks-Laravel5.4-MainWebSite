	...
	<div class="wrapper">
		...
		<div class="main-panel">
			<div class="container">
				...
				<form action="{{ url('/plusinsert', $data->id)}}" method="POST" enctype="multipart/form-data">
					{{csrf_field()}}
					{{ method_field('POST') }}
							...
							<div class="col-md-12">
								<div class="card full-height">
									...
									<div class="card-body">
										...
										<input name="minus_score" value="" hidden>
													...
													<div class="select2-input">
														<select id="basic" name="behavior_history" class="form-control">
															...
															<optgroup label="หมวดที่ 1 สร้างชื่อเสียงให้กับสถานศึกษา">
																...
																<option value="002 สร้างชื่อเสียงให้กับสถานศึกษา ระดับจังหวัด">002 สร้างชื่อเสียงให้กับสถานศึกษา ระดับจังหวัด (+20)</option>
																<option value="003 สร้างชื่อเสียงให้กับสถานศึกษา ระดับภาค">003 สร้างชื่อเสียงให้กับสถานศึกษา ระดับภาค (+30)</option>
																<option value="004 สร้างชื่อเสียงให้กับสถานศึกษา ระดับประเทศ">004 สร้างชื่อเสียงให้กับสถานศึกษา ระดับประเทศ (+50)</option>
															</optgroup>
															<optgroup label="หมวดที่ 2 ช่วยเหลือผู้ประสบอุบัติเหตุ หรือผู้ที่ได้รับอันตราย">
																<option value="005 ช่วยเหลือผู้ประสบอุบัติเหตุ">005 ช่วยเหลือผู้ประสบอุบัติเหตุ (+50)</option>
															</optgroup>
															<optgroup label="หมวดที่ 3 แจ้งเบาะแสให้ครู เจ้าหน้าที่ตำรวจ ในกรณีที่พบเห็นผู้กระทำความผิดทั้งใน และนอกสถานศึกษา">
																<option value="006 แจ้งเบาะแสให้ครู เจ้าหน้าที่ตำรวจ">006 แจ้งเบาะแสให้ครู เจ้าหน้าที่ตำรวจ (+20)</option>
															</optgroup>
														</select>
													</div>
												</div>
