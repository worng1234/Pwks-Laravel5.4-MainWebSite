							...
							<div class="card full-height">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title"><i class="fas fa-medal"></i> &nbsp;จัดการข้อมูลความประพฤติ <i class="flaticon-right-arrow"></i> ตรวจสอบความประพฤตินักเรียน<i class="flaticon-right-arrow"></i> Report <i class="flaticon-right-arrow"></i> ออกเอกสารแบบปีการศึกษา</div>

									</div>
								</div>
								<div class="card-body" style="min-height: auto">
									<div class="form-group">
										<form role="form" method="post" action="{{ url('/search/reportbehavioryear')}}">
											{{csrf_field()}}
											<div class="row">
