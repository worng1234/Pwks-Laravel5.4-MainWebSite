                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body" align="center" style="min-height: 450px">
                                    ...
                                    <p class="card-category">เพื่อตรวจสอบสิทธิ์ในการยื่นเอกสารรายงานตัวเพื่อเข้าเป็นนักเรียนในระดับชั้นมัธยมศึกษาปีที่ 1</p><br><br>

                                    <form action="{{ url('/search/documentM1')}}" method="post">
                                        {{ csrf_field() }}
                                        <div class="card-title" align="center">
                                            ...
                                            <button type="submit" class="btn btn-primary col-sm-6 col-md-2" href="{{ url('/Newstudent/documentM1onsubmit')}}"><i class="fas fa-search"></i> แสดง</button>
                                        </div>
                                    </form>
