    ...
    <div align="center">
        ...
        <form action="{{ url('/updated1', $newstudentm1Model->id)}}" method="post">
            ...
            <div class="card" style="width: 30rem;">
                <img class="card-img-top" src="/eim/public/newstudentm1AllPic/newstudentm1PIC/{{$newstudentm1Model->pic}}">
                <div class="card-body">
            ...
            <div class="card" style="width: 30rem;">
                <img class="card-img-top" src="/eim/public/newstudentm1AllPic/newstudentm1HOUSE/{{$newstudentm1Model->house_pic}}">
                <div class="card-body">
            ...
            <div class="card" style="width: 30rem;">
                <img class="card-img-top" src="/eim/public/newstudentm1AllPic/newstudentm1IDNUMBER/{{$newstudentm1Model->id_number_pic}}">
                <div class="card-body">
            ...
            <div class="card" style="width: 30rem;">
                <img class="card-img-top" src="/eim/public/newstudentm1AllPic/newstudentm1GRADE/{{$newstudentm1Model->grade_pic}}">
                <div class="card-body">
