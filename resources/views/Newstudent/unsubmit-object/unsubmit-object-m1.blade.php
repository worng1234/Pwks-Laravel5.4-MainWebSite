							...
							<div class="card full-height">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title"><i class="fas fa-id-card-alt fa-lg"></i> &nbsp;&nbsp; หลักฐานและข้อมูลการสมัครเข้าเรียน <i class="flaticon-right-arrow"></i> ยังไม่ได้ตรวจสอบ <i class="flaticon-right-arrow"></i> มัธยมศึกษาปีที่ 1</div>
										...
										<table id="basic-datatables" class="table table-bordered table-striped table-hover" style="width:100%">
											...
											<tbody>
												...
												<tr>
													...
													<td align="center"><a href='{{ url("/SortNewstudentM1/{$data->id}" )}}' class="btn btn-primary btn-xs"><i class="fas fa-file-archive"></i></a></td>
