							...
							<div class="collapse show" id="agree">
								<ul class="nav nav-collapse">
									...
									<li>
										...
										<div class="collapse show" id="formob2">
											<ul class="nav nav-collapse subnav">
												<li >
							...
							<div class="card full-height">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title"><i class="fas fa-id-card-alt fa-lg"></i> &nbsp;&nbsp; หลักฐานและข้อมูลการสมัครเข้าเรียน <i class="flaticon-right-arrow"></i> ตรวจสอบแล้ว <i class="flaticon-right-arrow"></i> มัธยมศึกษาปีที่ 4</div>
