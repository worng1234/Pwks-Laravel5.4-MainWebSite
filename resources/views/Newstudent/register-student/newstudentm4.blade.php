									...
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-sm-6 col-md-4">
												<div class="form-group form-group-default">
													<label>*เดือน:</label>
													<select class="form-control" id="slctMounth" name="mounth" onchange="populate(this.id,'slct2')" required>
														<option>เลือก</option>
											...
											<div class="col-sm-6 col-md-4">
												<div class="form-group form-group-default">
													<label>*วัน:</label>
													<select class="form-control" id="slct2" name="day" required>
										...
										<div class="row">
											...
											<div class="col-6 col-md-3">
												<div class="form-group form-group-default">
													<label>*หมู่</label>
													<input name="bloc" type="text" class="form-control" placeholder="" pattern="^[/||0-9\s]+$" title="กรุณากรอกให้ถูกต้อง" maxlength="10" required>
												</div>
											</div>
											<div class="col-6 col-md-3">
												<div class="form-group form-group-default">
										...
										<div class="row">
											<div class="col-sm-6 col-md-12">
												<div class="form-group form-group-default">
													...
													<input name="student_id" type="text" class="form-control" pattern="^[0-9\s]+$" title="กรุณากรอกเลขประจำตัวนักเรียนเป็นตัวเลข" maxlength="6" placeholder="">
												</div>
											</div>
										</div>
