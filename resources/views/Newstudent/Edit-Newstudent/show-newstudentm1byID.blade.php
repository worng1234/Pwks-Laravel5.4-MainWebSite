							...
							<div class="card full-height">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title">ข้อมูลประจำตัวของ {{$data->prename}}{{$data->fname}} {{$data->surname}}</div>
									</div>
								</div>
								...
								<div class="card-footer" align="center">
									<a href='{{ url("/EditNewstudentM1/{$data->id}" )}}' class="btn btn-warning "><strong>แก้ไขข้อมูล</strong></a>
								</div><br>
