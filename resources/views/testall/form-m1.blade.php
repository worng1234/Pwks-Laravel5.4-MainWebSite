					...
					<ul class="nav page-navigation page-navigation-info bg-white">
						...
						<li class="nav-item submenu active">
							...
							<div class="navbar-dropdown animated fadeIn">
								<ul>
									<li>
										<a href="form-agreement-m1.html">สมัครเข้าเรียนชั้นมัธยมศึกษาปีที่ 1</a>
									</li>
									<li>
										<a href="form-agreement-m4.html">สมัครเข้าเรียนชั้นมัธยมศึกษาปีที่ 4</a>
									</li>
									<li>
										<a href="form-check-index.html">ตรวจสอบสถานะการสมัครเข้าเรียน</a>
									</li>
								</ul>
							</div>
						</li>
									...
									<div class="row">
										<div class="col-sm-6 col-md-12">
											<div class="form-check">
												...
												<label class="form-radio-label">
													<input class="form-radio-input" type="radio"  value="ผู้ด้อยโอกาส/ฐานะยากจน" name="poor_person">
