                            ...
                            <div class="card full-height">
                                <div class="card-header">
                                    <div class="card-head-row">
                                        <div class="card-title"><i class="fas fa-user-cog fa-lg"></i> &nbsp;&nbsp; จัดการแอคเค้าท์ฝ่ายกิจการ</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form method="post" action="{{ url('/AdminAffairEditID', $data->id)}}" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                            ...
                                            <div class="row">
                                                <div class="col-6 col-md-6">
                                                    <div class="form-group form-group-default">
                                                        ...
                                                        <input id="Name" type="text" class="form-control" value="{{$data->username}}" name="username">
                                                    </div>
                                                </div>
                                                <div class="col-6 col-md-6">
                                                    <div class="form-group form-group-default">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-md-4">
                                                    <div class="form-group form-group-default">
                                                        ...
                                                        <input id="Name" type="text" class="form-control" value="{{$data->fname}}" name="fname">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6 col-md-4">
                                                    <div class="form-group form-group-default">
                                                        ...
                                                        <input id="Name" type="text" class="form-control" value="{{$data->surname}}" name="surname">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-footer" align="center"><br>
                                            ...
                                            <a href="{{url('/AdminAll/Affair')}}" class="btn btn-danger" style="margin-left: auto;">ย้อมกลับ</a>
                                        </div><br>
