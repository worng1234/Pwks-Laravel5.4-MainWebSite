                            ...
                            <div class="card full-height">
                                <div class="card-header">
                                    <div class="card-head-row">
                                        <div class="card-title"><i class="fas fa-user-cog fa-lg"></i> &nbsp;&nbsp; จัดการแอคเค้าท์แอดมิน</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form method="post" action="{{ url('/AdminEditID', $data->id)}}" enctype="multipart/form-data">
                                        ...
                                        <div class="card-footer" align="center"><br>
                                            ...
                                            <a href="{{url('/AdminAll/Admin')}}" class="btn btn-danger" style="margin-left: auto;">ย้อมกลับ</a>
                                        </div><br>
