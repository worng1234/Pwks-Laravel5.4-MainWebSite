...
<body class="login">
  <div class="wrapper wrapper-login">
    <div class="container container-login animated fadeIn">
      ...
      <form class="form-horizontal" method="POST" action="{{ route('affair.login.submit') }}">
        {{ csrf_field() }}
        <div class="text-center"><b style="font-size: 23px; ">ยินดีต้อนรับเข้าสู่ระบบ</b><br><small> สำหรับเจ้าหน้าที่ฝ่ายกิจการนักเรียน</small></div>
        <div class="login-form">
          <div class="form-group">
            <label for="username" class="placeholder"><b>ชื่อผู้ใช้</b></label>
            <input id="username" name="username" type="text" class="form-control" placeholder="กรอกชื่อผู้ใช้" value="{{ old('username') }}" required autofocus>
          </div>
          <div class="form-group">
          ...
          <div class="form-action mb-3">
            <button type="submit" class="btn btn-danger btn-rounded col-md-5 mt-3 mt-sm-0 fw-bold">เข้าสู่ระบบ</button>
          </div>
        </div>
    </div>
    </form>
