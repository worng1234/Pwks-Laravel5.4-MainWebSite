		...
		<div class="main-panel">
			<div class="container">
				<div class="page-inner">
					<div class="card">
						<div class="card-body">
							<div class="card-title fw-mediumbold" align="center">ตรวจสอบสถานะการสมัครเข้าเรียนในระดับชั้นมัธยมศึกษาปีที่ 4</div><div align="center">
								<br>
							<div class="card-title fw-mediumbold"  style="color:red;">กรอกข้อมูลผิดพลาดกรุณาลองใหม่อีกครั้ง</div>
							<br>
							<div class="col-md-5">
							<a href="{{ url('/RegisM4/login')}}"class="btn btn-secondary btn-rounded col-md-5 mt-3 mt-sm-0 fw-bold" style="margin-right:auto;">ลองอีกครั้ง</a>
							</div>
