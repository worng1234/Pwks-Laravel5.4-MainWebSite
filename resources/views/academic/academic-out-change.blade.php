							...
							<div class="card full-height">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title"><i class="fas fa-user-graduate fa-lg"></i> &nbsp;&nbsp; จัดการข้อมูลนักเรียน <i class="flaticon-right-arrow"></i> ออกกลางคัน <i class="flaticon-right-arrow"></i> เพิ่มข้อมูลออกกลางคัน</div>

									</div>
								</div>
								<div class="card-body" style="min-height: 370px">

									<form role="form" method="post" action="{{ url('/Searchacademic/outChange')}}">
										{{csrf_field()}}
								...
								<form role="form" method="post" action="{{ url('/academic/classChangeOut')}}">
									{{csrf_field()}}
									<div align="right">
												...
												<tr>
													...
													<td align="center">
														<select id="inputStatus" name="status[]">
															<option value="01" <?php if ($value->status == "01") { ?> selected="selected" <?php } ?>>กำลังศึกษาอยู่</option>
															<option value="04" <?php if ($value->status == "04") { ?> selected="selected" <?php } ?>>ออกกลางคัน</option>
														</select>
													</td>
												</tr>
												@endforeach
