	...
	<div class="wrapper">
		...
		<div class="main-panel">
			<div class="container">
				...
				<form method="post" action="{{ url('/classRoomEdit', $data->id)}}" enctype="multipart/form-data">
					{{csrf_field()}}
							...
							<div class="col-md-12">
								<div class="card full-height">
										...
										<div class="row">
											...
											<div class="col-6 col-md-6">
												<div class="form-group form-group-default">
													...
													<input id="Name" type="text" class="form-control" name="class_room" value="{{$data->class_room}}">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card-footer" align="center"><br>
										...
										<a href="{{ url('/academic/classRoom')}}" class="btn btn-danger"><i class="fas fa-angle-left"></i> ย้อนกลับ</a>
									</div><br>
