	...
	<div class="wrapper">
		...
		<div class="main-panel">
			<div class="container">
				...
				<form method="post" action="{{ url('/classMajorEdit', $data->id)}}" enctype="multipart/form-data">
					{{csrf_field()}}
								...
								<div class="card full-height">
									<div class="card-header">
										<div class="card-head-row">
											<div class="card-title"><i class="fas fa-sliders-h fa-lg"></i> &nbsp;&nbsp; จัดการข้อมูลพื้นฐาน <i class="flaticon-right-arrow"></i> เพิ่มข้อมูลสายการเรียน </div>
										</div>
									</div>
										...
										<div class="row">
											<div class="col-6 col-md-6">
												<div class="form-group form-group-default">
													...
													<input id="Name" type="text" class="form-control" name="class_id" value="{{$data->class_id}}" >
												</div>
											</div>
											<div class="col-6 col-md-6">
												<div class="form-group form-group-default">
													<label>สายการเรียน</label>
													<input id="Name" type="text" class="form-control" name="class_major_name" value="{{$data->class_major_name}}">
												</div>
											</div>
										</div>
									</div>
