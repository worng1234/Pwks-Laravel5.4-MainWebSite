							...
							<div class="card full-height">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title"><i class="fas fa-file-alt fa-lg"></i> &nbsp;&nbsp; หลักฐานรายงานตัวและโอนย้ายข้อมูล <i class="flaticon-right-arrow"></i> ตรวจสอบแล้วแต่ยังไม่ได้โอนย้าย <i class="flaticon-right-arrow"></i> มัธยมศึกษาปีที่ 4</div>
									</div>
								</div>
								<div class="card-body" style="min-height: 370px">

								<form role="form" method="post" action="{{ url('/SearchsubmitNotTranferM4')}}">
										{{csrf_field()}}
											...
											<tbody>
												...
												<tr>
													...
													<td align="center">
                                                        ...
                                                        @endif</td>
													<td align="center">
														<a href='{{ url("/tranferM4/{$value->id}")}}' class="btn btn-secondary btn-sm" style="margin-left: auto;"><i class="fas fa-paste"></i></a>
													</td>
												</tr>
												@endforeach
