						...
						<div class="col-md-12">
							<div class="card full-height">
                                ...
                                <div class="card-body" style="min-height: auto">
                                    <a type="button" href="{{ url('/academic/classMajorAdd')}}" class="btn btn-primary ml-1 mb-4" ><i class="fas fa-user-plus"></i> เพิ่มข้อมูลสายการเรียน</a>

                                    <!-- ตารางแสดงข้อมูล-->
									<div class="table-responsive">
													<table id="" class="table table-bordered table-striped table-hover" style="width:70%">
														<thead>
															<tr>
																<th scope="col" width="5%"><center>รหัส</center></th>
																<th scope="col" width="20%"><center>สายการเรียน</center></th>
																<th scope="col" width="5%"><center>จัดการ</center></th>
																<th scope="col" width="5%"><center>ลบข้อมูล</center></th>
														...
														<tbody>
															...
															<tr>
																...
																<td>{{$value->class_major_name}}</td>
																<td align="center">
																	<a href='{{ url("/classMajorShow/{$value->id}")}}' class="btn btn-primary btn-xs"><i class="fas fa-edit"></i></a>
																</td>
																<td align="center">
																	<a href='{{ url("/classMajorDelete/{$value->id}")}}' class="btn btn-danger btn-xs" title="" onclick="return confirm('ยืนยันที่จะลบข้อมูลนี้หรือไม่')"> <i class="fas fa-trash"></i> </a>
																</td>
															</tr>
                                                            @endforeach
