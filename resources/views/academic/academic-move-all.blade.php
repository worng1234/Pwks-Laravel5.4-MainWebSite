							...
							<div class="card full-height">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title"><i class="fas fa-user-graduate fa-lg"></i> &nbsp;&nbsp; จัดการข้อมูลนักเรียน <i class="flaticon-right-arrow"></i> แสดงข้อมูลเลื่อนชั้นเรียน </div>
									</div>
								</div>
								<div class="card-body" style="min-height: 370px">

								<form role="form" method="post" action="{{ url('/Searchacademic/move')}}">
										{{csrf_field()}}
